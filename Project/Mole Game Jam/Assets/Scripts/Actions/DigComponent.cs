...
public class DigComponent : MonoBehaviour
{
    ...
    public void Dig(Entity digger)
    {
        ...
        _dir = _origin + Vector3.forward;
    }

    private void OnDrawGizmos()
    {
        
        Debug.DrawRay(_origin, _origin + Vector3.forward * MAXHitDistance, Color.red);
        Gizmos.DrawWireCube(_origin + (_dir.normalized * MAXHitDistance), BoxCastSize1);
